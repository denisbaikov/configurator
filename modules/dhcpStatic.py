...
class Page1(QWidget):
    ...
    def parserConfigFile(self):
        ...
        #saveButton.setMaximumSize(200, 20);
        ...
        #addButton.setMaximumSize(200, 20);
        ...
        self.gridLayout.addItem(spacer, *(2, 0), 1, 2)
    ...
    def addUI(self, dummy, hostname="add", mac="add", ip="add"):
        ...
        button = QPushButton()
        button.setObjectName("buttonSave")
        ...
        gridLayout.addWidget( button, 0, 3, 1, 1)
        ...
        spacer = QSpacerItem(0, 10, QSizePolicy.Expanding, QSizePolicy.Expanding)
        gridLayout_2.addItem(spacer, *(5, 0), 1, 3)
        
        self.gridLayout.addLayout(gridLayout_2, self.ii, 0, 1, 2)
        self.ii += 1
